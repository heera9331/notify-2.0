  ...
  return (
    <Accordion type="multiple" className="w-full mt-[-8px]">
      {categories.map((category) => (
        ...
        >
          <AccordionTrigger
            className="flex items-center gap-2 cursor-pointer bg-gray-100 rounded-md w-full p-2"
          ...
          <AccordionContent>
            {loading[category.id] ? (
              ...
              <SidebarMenu className="ml-4 my-2">
              ...
              <p className="ml-4 mx-4 text-sm text-gray-500">
                No subcategories
              </p>
            )}
          </AccordionContent>
